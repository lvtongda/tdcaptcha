    ...
    <body>
        <form name='frmAdd' method='post' action='addclient.php' onsubmit='return doCheck()'>
            <table width='350' border='0' align='center' cellpadding='8'>
                <tr width='40%'>
                    <td>域名：</td>
                    <td><input name='weburl' type='text' id='weburl' class='textinput' value='' /></td>
                </tr>
                <tr>
                    <td>公钥：</td>
                    <td><input name='publickey' type='text' id='publickey' class='textinput' value='' /></td>
                </tr>
                <tr>
                    <td>私钥：</td>
                    <td><input name='privatekey' type='text' id='privatekey' class='textinput' value='' /></td>
                </tr>
